...
namespace Sales.API.Controllers
{
    ...
    public class TemporalSalesController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post(TemporalSaleDTO temporalSaleDTO)
        {
            ...
            //Por seguridad el usuario no se envia en el modelo que viene del cliente, sino unicamente del usuario que esta logueado, por eso se hace con User.Identity!.Name
